...
本项目旨在为IP多变的小集群提供管理能力。主要能力包含用户管理、服务器管理、账号管理、Web终端、文件管理、批量任务、资源监控及IP主动上报等。<a href="http://1.116.106.76cd:8080/" target="_blank">demo</a> 账号：`admin@eaxmple.com` 密码：`123456`.目前支持管理服务器系统类型：
