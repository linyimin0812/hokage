...
interface ExecutedBatCommandInfoPropsType {
  isVisible: boolean,
...
export default class ExecutedBatCommandInfo extends React.Component<ExecutedBatCommandInfoPropsType, ExecutedBatCommandInfoStateType> {
  ...
  render() {
    ...
    return (
      ...
      >
        <Form{...formItemLayout}>
          <Form.Item name="name" label="任务名称" rules={[{ required: true, message: "任务名称不能为空" }]}>
            <span>备份数据库数据</span>
          </Form.Item>
          ...
          <Form.Item name="execTime" label="执行时长">
            <span>小于1秒</span>
          </Form.Item>
